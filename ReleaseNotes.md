**Notice : do not update to v3.41.0.0 if you use a Media Services account in Azure China or Azure Government. These instances need to be updated to support the latest SDK.**
