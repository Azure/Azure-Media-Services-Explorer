Version 3.43.0.0 brings the following features and improvements :

* Support for **Azure Media Telemetry** (Private Preview - activated on some accounts)
...
* New **First Quality Bitrate for HLS** in filters
