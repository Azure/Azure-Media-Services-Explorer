namespace AMSExplorer
{
    partial class TransformTypeCreation
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.errorProvider1.SetError(this.radioButtonCustomJson, resources.GetString("radioButtonCustomJson.Error"));
            this.errorProvider1.SetIconAlignment(this.radioButtonCustomJson, ((System.Windows.Forms.ErrorIconAlignment)(resources.GetObject("radioButtonCustomJson.IconAlignment"))));
            this.errorProvider1.SetIconPadding(this.radioButtonCustomJson, ((int)(resources.GetObject("radioButtonCustomJson.IconPadding"))));
