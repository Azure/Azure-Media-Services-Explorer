namespace AMSExplorer
{
    partial class StreamingEndpointInformation
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBoxTypeScale.Controls.Add(this.linkLabelAutoscale);
            ...
            this.errorProvider1.SetError(this.linkLabelAutoscale, resources.GetString("linkLabelAutoscale.Error"));
            this.errorProvider1.SetIconAlignment(this.linkLabelAutoscale, ((System.Windows.Forms.ErrorIconAlignment)(resources.GetObject("linkLabelAutoscale.IconAlignment"))));
            this.errorProvider1.SetIconPadding(this.linkLabelAutoscale, ((int)(resources.GetObject("linkLabelAutoscale.IconPadding"))));
            this.linkLabelAutoscale.Name = "linkLabelAutoscale";
            this.linkLabelAutoscale.TabStop = true;
            this.toolTip1.SetToolTip(this.linkLabelAutoscale, resources.GetString("linkLabelAutoscale.ToolTip"));
            this.linkLabelAutoscale.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.moreinfoSE_LinkClicked);
            // 
            // radioButtonPremium
            // 
